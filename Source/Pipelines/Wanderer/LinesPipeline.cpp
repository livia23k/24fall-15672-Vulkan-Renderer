...
#include "spv/Source/Shader/Wanderer/lines.vert.inl"
    ;

static uint32_t frag_code[] =
#include "spv/Source/Shader/Wanderer/lines.frag.inl"
    ;

void Wanderer::LinesPipeline::create(RTG &rtg, VkRenderPass render_pass, uint32_t subpass)
{
...
void Wanderer::LinesPipeline::destroy(RTG &rtg)
{
