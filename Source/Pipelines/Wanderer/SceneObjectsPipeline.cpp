...
#include "spv/Source/Shader/Wanderer/sceneobjects.vert.inl"
    ;

static uint32_t frag_code[] =
#include "spv/Source/Shader/Wanderer/sceneobjects.frag.inl"
    ;

void Wanderer::SceneObjectsPipeline::create(RTG &rtg, VkRenderPass render_pass, uint32_t subpass)
{
...
void Wanderer::SceneObjectsPipeline::destroy(RTG &rtg)
{
