...
#include "spv/Source/Shader/Wanderer/background.vert.inl"
    ;

static uint32_t frag_code[] =
#include "spv/Source/Shader/Wanderer/background.frag.inl"
    ;

void Wanderer::BackgroundPipeline::create(RTG &rtg, VkRenderPass render_pass, uint32_t subpass)
{
...
void Wanderer::BackgroundPipeline::destroy(RTG &rtg)
{
